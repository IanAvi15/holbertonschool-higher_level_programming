#!/usr/bin/python3
"""Module that defines a Rectangle class with square creation method."""
...
class Rectangle:
    ...
    def __str__(self):
        ...
        Returns:
            A string representation using print_symbol for the rectangle.
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Args:
            rect_1: The first rectangle (must be a Rectangle instance).
            rect_2: The second rectangle (must be a Rectangle instance).

        Returns:
            rect_1 if both have the same area or if rect_1 is bigger.
            rect_2 if rect_2 is bigger.
    ...
    def square(cls, size=0):
        ...
        Args:
            size: The size of the square (default is 0).
                  Sets both width and height to this value.
